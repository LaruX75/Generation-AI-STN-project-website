...
permalink: /en/news-from/genai-project-staff-at-events/genai-involved-in-girls-day-events/
status: publish
sourceType: posts
...
<p>After that, it was time to get to know the AI application itself, the <a href="https://www.generation-ai-stn.fi/genai-opetettava-kone/" target="_blank" rel="noopener" title="GenAI Teachable Machine">machine learning</a> application developed in our project. First, we introduced the AI technologies behind the application, and then the students were able to create different machine learning applications themselves.  </p>

<p>Judging by the general enthusiasm, the young people were very excited about the opportunity to be among the first schoolchildren in our country to be introduced to an AI literacy app!  </p>
