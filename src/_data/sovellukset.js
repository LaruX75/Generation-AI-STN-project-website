...
module.exports = {
  ...
  /* ── Suomi ───────────────────────────────────────────────────────────── */
    ...
    },
    {
      ...
      status: "beta",
      desc: "Pelaaja saa datavihjeitä ja yrittää päätellä, kenestä henkilöstä on kyse. Harjoittelee kriittistä datanlukutaitoa luokkahuoneessa.",
      teacherDesc: "Arvaa kuka -tyyppinen peli: oppilaat päättelevät datajälkien perusteella henkilöllisyyden ja oppivat, mitä tietoa kerätään ja mitä se paljastaa.",
  ...
  en: [
    ...
    },
    {
      ...
      type: "Privacy & Data",
      status: "beta",
      desc: "Players receive data clues and try to figure out who a person is. Develops critical data literacy in the classroom.",
      teacherDesc: "Guess-who style game: students identify individuals from their digital traces and learn what data reveals about them.",
  ...
  sv: [
    ...
    },
    {
      ...
      status: "beta",
      desc: "Spelaren får dataledtrådar och försöker ta reda på vem en person är. Övar kritisk dataläskunnighet i klassrummet.",
      teacherDesc: "Gissa vem-spel: elever identifierar individer utifrån digitala spår och lär sig vad data avslöjar om dem.",
